...
public abstract class CatalogDialogCreator {
    ...
    protected final SellerProductsController productsController;
    ...
    protected CatalogDialogCreator(String title, CatalogForm initial, Button ownerButton,
    ...
    protected void resetCommonFieldStyles(ProductUI ui, Styles styles) {
        ui.size().setStyle(styles.base());
        ui.price().setStyle(styles.base());
        ui.qty().setStyle(styles.base());
    }

    protected boolean validateCommonFields(ProductUI ui, Styles styles) {
        if (ui.size().getText().isBlank()) {
            ui.size().setStyle(styles.error());
            showAlert(Alert.AlertType.WARNING, "Taglia obbligatoria");
            return false;
        }
        ...
        try {
            ...
            ui.price().setStyle(styles.error());
